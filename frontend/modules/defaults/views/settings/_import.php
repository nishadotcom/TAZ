        ...
        <div class="widget-container fluid-height clearfix">
            <div class="widget-content padded">
                <table width="100%" border="0">
                    <tr>
                        <td width="88%">&nbsp;</td>
                        <td width="5%"><a class="btn btn-success role" href="<?= Yii::$app->urlManager->createUrl('defaults/settings/index') ?>">Back</a></td>
                    </tr>
                </table>
                        ...
                        <div class="col-md-7">
                            ...
                            ?><br />
                             <div class="type">                         
                                ...
                                Download the <a href="<?= Yii::$app->urlManager->createUrl('uploads/template') ?>/settings-template.csv">Template</a> and fill the details for import</div>
                    ...
                    <div class="col-lg-12">
                        <div class="form-group btnGroup">
                            ...
                            <div class="col-md-8">
                                ...
                                <a class="btn btn-default-outline" href="<?= Yii::$app->urlManager->createUrl('defaults/settings/index') ?>">Cancel</a> </div> 
                            </div>
                        </div>
                    </div>  
                </div>
