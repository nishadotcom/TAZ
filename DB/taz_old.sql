...
--
-- Host: localhost
-- Generation Time: Jul 29, 2017 at 11:39 AM
...
INSERT INTO `taz_category` (`id`, `category_name`, `category_description`, `category_image`, `category_status`, `created_on`, `updated_on`) VALUES
(1, 'Tst', 'dhdfh', '20170711065801-ads4.jpg', 'Active', '2017-07-11 06:58:01', '2017-07-11 07:01:32');
...
--
-- Dumping data for table `taz_slideshow`
--

INSERT INTO `taz_slideshow` (`id`, `title`, `description`, `image_name`, `status`, `order_by`, `created_on`, `modified_on`) VALUES
(2, 'Test', 'test', '20170715013501-BeautyPlus-20170627194548-save.jpg', 'Active', 1, '2017-07-15 13:40:54', NULL);
...
INSERT INTO `taz_user` (`id`, `username`, `firstname`, `lastname`, `email`, `mobile`, `password`, `auth_key`, `registered_mode`, `profile_image`, `profile_status`, `product_count`, `user_loyalty`, `user_type`, `status`, `registration_ip`, `created_at`, `updated_at`) VALUES
(1, '', 'pradeep', 'a', 'pradbics@gmail.com', '7094280810', '657047263c96362700718f6768437139', NULL, 'Web', '20170705075126-BeautyPlus-20170627194548-save.jpg', 'Not-Completed', 0, NULL, 'Buyer', 'Active', '0.0.0.0', '0000-00-00 00:00:00', '0000-00-00 00:00:00'),
(2, 'admin', 'pradeep', 'a', 'admin@gmail.com', '7094280810', 'e6e061838856bf47e1de730719fb2609', NULL, 'Web', '20170705075126-BeautyPlus-20170627194548-save.jpg', 'Not-Completed', 0, NULL, 'Buyer', 'Active', '0.0.0.0', '0000-00-00 00:00:00', '0000-00-00 00:00:00'),
(4, '', 'pradeep', 'A', 'apradeep.anthony@gmail.com', '70942801810', 'febc8f8ac083f5fc27e032c81e7b536a', NULL, 'Web', '20170719071638-14445024-1796211007330570-7926161578091169327-o.jpg', 'Not-Completed', 0, NULL, 'Buyer', 'Active', '0.0.0.0', '0000-00-00 00:00:00', '0000-00-00 00:00:00');
...
CREATE TABLE `taz_user_contact_detail` (
  `id` int(12) NOT NULL,
  `user_id` int(12) NOT NULL,
  `type` enum('shipping_address','billing_address') NOT NULL,
  `mobile` varchar(15) DEFAULT NULL,
...
--
-- Dumping data for table `taz_user_contact_detail`
--

INSERT INTO `taz_user_contact_detail` (`id`, `user_id`, `type`, `mobile`, `land_line_number`, `street`, `city`, `state`, `country`, `pin_code`, `updated_at`) VALUES
(1, 1, 'shipping_address', '678589i75', '468648', '57u468', 'turty', 'Arkansas', 'India', '12123', '2017-07-19 20:00:37'),
(2, 2, 'billing_address', '678589i75', '547568', 'GH road', 'gdhfgh', 'Arkansas', '114', '12123', NULL);
...
--
-- Dumping data for table `taz_user_detail`
--

INSERT INTO `taz_user_detail` (`id`, `user_id`, `short_about_me`, `long_about_me`) VALUES
(1, 1, 'ghgj', 'dhdgj'),
(2, 4, 'Test', 'TestTestTestTestTestTestTestTestTestTest');
...
--
-- Table structure for table `taz_user_payment_detail`
--

CREATE TABLE `taz_user_payment_detail` (
  `id` int(12) NOT NULL,
  `user_id` int(12) NOT NULL,
...
--
-- Indexes for table `taz_country`
--
ALTER TABLE `taz_country`
  ADD PRIMARY KEY (`id`);
...
--
-- Indexes for table `taz_user_payment_detail`
--
ALTER TABLE `taz_user_payment_detail`
  ADD PRIMARY KEY (`id`),
  ADD KEY `fk_taz_user_payment_detail_user_id` (`user_id`);
...
--
-- AUTO_INCREMENT for table `taz_country`
--
ALTER TABLE `taz_country`
...
ALTER TABLE `taz_user_favorite`
  MODIFY `id` int(12) NOT NULL AUTO_INCREMENT;
--
-- AUTO_INCREMENT for table `taz_user_payment_detail`
--
ALTER TABLE `taz_user_payment_detail`
  MODIFY `id` int(12) NOT NULL AUTO_INCREMENT;
--
...
--
-- Constraints for table `taz_user_payment_detail`
--
ALTER TABLE `taz_user_payment_detail`
