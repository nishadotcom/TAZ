...
use Yii;
use app\modules\defaults\models\Company;
use common\models\User;
use app\models\Project;
use app\modules\defaults\models\CompanySearch;
...
class CompanyController extends Controller
{
	...
	**/
    ...
    {
	$userCount = count(Project::find()->where('companyId=' . $id)->all());
        if ($userCount > 0) {
            Yii::$app->getSession()->setFlash('msg', '<div class="alert alert-warning">'. Yii::t("app","Company linked with Project") .'</div>');
            return $this->redirect(['index']);
        }
    ...
    /**
     * To import csv data to Company table
     * @return type
     */
