                ...
                <form action="" class="row" method="POST" role="form">
                  ...
                  <div class="col-xs-12">
                    <div class="well well-lg clearfix">
                      <ul class="pager">
                      <li class="previous"><a href="<?php echo Yii::$app->homeUrl.'demo/checkout_step3'; ?>">Back</a></li>
                        <li class="next"><a href="<?php echo Yii::$app->homeUrl.'demo/checkout_complete'; ?>">Confirm</a></li>
                      </ul>
                    </div>
                  </div>
                </form>
