...
class Product extends \yii\db\ActiveRecord
{
    ...
    {
        return [
            [['product_category_id', 'product_code', 'product_name', 'product_seo', 'product_owner_id', 'product_material', 'product_color', 'created_on', 'product_price', 'product_breadth', 'product_weight', 'product_long_description'], 'required'],
            [['product_long_description'], 'required','on'=>'admin_validate'],
            ...
            [['product_height'], 'default', 'value'=>0.00],
            [['product_length'], 'default', 'value'=>0.00],
