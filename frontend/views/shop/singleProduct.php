              ...
              <div class="media">
                ...
                <div class="media-body">
                  ...
                  <div class="btn-area">
                    ...
                    <button style="margin-top: 0;" class="btn btn-success btn-block buy" data-product-id="<?= $productData->id; ?>" data-user-id="<?php echo (!Yii::$app->user->isGuest) ? Yii::$app->user->id : 'guest'; ?>">Buy Now <i class="fa fa-angle-right" aria-hidden="true"></i></button>
                  </div>
                  <div class="tabArea">
...
<div class="row">
  <div class="col-xs-12">
    <div class="page-header">
      <h4 class="media-heading"><a href="/shop/products/4" title="FRC Products">Other Products</a></h4>
    </div>
  </div>
